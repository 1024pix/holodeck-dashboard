...
Generated on Tue, 13 Apr 2021 00:47:46
...
* URL: [https://carbure.beta.gouv.fr/accounts/resend-activation-link](https://carbure.beta.gouv.fr/accounts/resend-activation-link)
  ...
  * Evidence: `9x7FPSQGbOyv6KXIEkSpibUfomDNSrrteITyAQKsjSbo69Lk5uUsKcP521KYtHMk`
...
* URL: [https://carbure.beta.gouv.fr/accounts/register](https://carbure.beta.gouv.fr/accounts/register)
  ...
  * Evidence: `fUhp3KzIzsUk8PGdusip6R8OPi4qvCPARRc01mbpXcRuOyanfpsHy0nCIJRU839x`
...
### Other information
<p>�\x001e�=$\x0006l���\x0012D���\x001f�`�J��x��\x0001\x0002��&������,)���R��s$</p>
...
### Other information
<p>User-controlled HTML attribute values were found. Try injecting special characters to see if XSS might be possible. The page at the following URL:</p><p></p><p>https://carbure.beta.gouv.fr/accounts/resend-activation-link</p><p></p><p>appears to include user input in: </p><p></p><p>a(n) [input] tag [value] attribute </p><p></p><p>The user input found was:</p><p>email=foo-bar@example.com</p><p></p><p>The user-controlled value was:</p><p>foo-bar@example.com</p>
